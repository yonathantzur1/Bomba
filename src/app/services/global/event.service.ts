...
export enum EVENT_TYPE {
    ...
    REQUESTS_SEND_MODE, DELETE_REPORT, EDIT_USERNAME, DELETE_USER,
    CLOSE_TEST_REQUEST, CLOSE_REPORT_FOLDER, CLOSE_EDIT_VALUE, CLOSE_REPORT_DOCUMENT, DELETE_CELL, OPEN_REQUEST_EDIT,
    OPEN_REQUEST_VIEW, ADD_ENVIRONMENT, UPDATE_ENVIRONMENT, DELETE_ENVIRONMENT, ACTIVE_ENVIRONMENT,
    SELECT_ENVIRONMENT
};