...
export enum EVENT_TYPE {
    ...
    CLOSE_TEST_REQUEST, CLOSE_EDIT_VALUE, CLOSE_REPORT_DOCUMENT, DELETE_CELL,
    OPEN_REQUEST_EDIT, ADD_ENVIRONMENT, UPDATE_ENVIRONMENT, DELETE_ENVIRONMENT, ACTIVE_ENVIRONMENT
};